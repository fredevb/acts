...
#include "ActsExamples/Tutorial/TracccAlgorithm.hpp"

#include <stdexcept>

ActsExamples::TracccAlgorithm::TracccAlgorithm(
    ActsExamples::TracccAlgorithm::Config cfg, Acts::Logging::Level lvl)
    : ActsExamples::IAlgorithm("TracccAlgorithm", lvl),
      m_cfg(std::move(cfg)) {
...
ActsExamples::ProcessCode ActsExamples::TracccAlgorithm::execute(
